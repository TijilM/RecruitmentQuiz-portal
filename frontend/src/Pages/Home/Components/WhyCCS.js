                ...
                <Fade right>
                    <div className={styles.whyccsItem}>
                        <div>
                            ...
                            <div className={styles.content}>The society provides good exposure by providing adequate opportunities, guidance and examples to help its members bloom.</div>
                        </div>
